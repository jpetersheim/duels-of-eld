...
var player_deck = ["Knight", "Archer", "Demon", "Knight", "Knight", "Knight", "Knight", "Knight", "Archer", "Archer", "Archer"]
...
func _ready() -> void:
	...
	player_deck.shuffle()
	$NumInDeck.text = str(player_deck.size())
...
func draw_card():
	#if $"../PlayerHand".player_hand.size() >= hand_card_limit:
		#can_draw_card = false
			#
	#if !can_draw_card:
		#return
